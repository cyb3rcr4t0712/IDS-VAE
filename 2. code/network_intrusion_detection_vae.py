...
import os
os.system('wget http://kdd.ics.uci.edu/databases/kddcup99/kddcup.data.gz')
os.system('wget http://kdd.ics.uci.edu/databases/kddcup99/corrected.gz')
os.system('wget http://kdd.ics.uci.edu/databases/kddcup99/kddcup.names')
# Unzipping the files
os.system('gzip -d /content/kddcup.data.gz')
os.system('gzip -d /content/corrected.gz')
